...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http, JwtAuthenticationFilter jwtFilter)
        ...
        http.authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/v1/rules").hasAnyRole("VIEWER", "EDITOR")
                .requestMatchers(HttpMethod.GET, "/api/v1/rules/*/preview").hasAnyRole("VIEWER", "EDITOR")
                .requestMatchers(HttpMethod.GET, "/api/v1/rules/*").hasAnyRole("VIEWER", "EDITOR")
                .requestMatchers(HttpMethod.PATCH, "/api/v1/rules/*").hasRole("EDITOR")
                .requestMatchers(HttpMethod.POST, "/api/v1/rules/*/evaluate").hasRole("EDITOR")
                .requestMatchers(HttpMethod.GET, "/api/v1/signals").hasAnyRole("VIEWER", "EDITOR")
                .requestMatchers(HttpMethod.GET, "/api/v1/signals/*").hasAnyRole("VIEWER", "EDITOR")
